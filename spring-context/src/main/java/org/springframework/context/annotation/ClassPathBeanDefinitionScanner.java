...
public class ClassPathBeanDefinitionScanner extends ClassPathScanningCandidateComponentProvider {
	...
	// 即Spring默认扫描配置@Component、@Repository、@Service、@Controller注解的Bean，同时也支持Java EE6的@ManagedBean和JSR-330的@Named注解
	 ...
	 */
	// 扫描指定包路径及其子包下的注解类，为类使新添加的类被处理，必须手动调用refresh()方法刷新容器
	// 调用类路径Bean定义扫描器入口方法
